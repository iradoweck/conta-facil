...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color mainColor = isIncome ? AppColors.success : AppColors.alert;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildAmountInput(mainColor),
            const SizedBox(height: 32),
            _buildTypeToggle(),
            const SizedBox(height: 24),
            _buildContextToggle(),
            const SizedBox(height: 32),
            Text('Detalhes', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          padding: EdgeInsets.only(
            left: 24,
            right: 24,
            bottom: MediaQuery.of(context).viewInsets.bottom > 0 ? 16 : 24, // Adapts to keyboard
            top: 16,
          ),
          child: SizedBox(
  ...
  Widget _buildAmountInput(Color mainColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        const Text('Valor (MT)', style: TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.w600)),
        TextField(
          controller: _amountController,
          autofocus: true,
          textAlign: TextAlign.center,
          style: TextStyle(fontSize: 48, fontWeight: FontWeight.w900, color: mainColor, letterSpacing: -2.0),
